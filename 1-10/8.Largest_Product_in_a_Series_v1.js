...
function display(objectToBeDisplayed) {
    ...
    console.log(`${numbersToBeMultiplied} = ${finalResult}`);
}

display(largestNDigitProductFinder(arr, 13));