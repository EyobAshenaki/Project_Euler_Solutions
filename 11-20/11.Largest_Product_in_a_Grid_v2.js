...
for (var i = 0; i < compareArr.length; i++) {
    let tempSum = compareArr[i].reduce(function (a, b) {
        return a * b;
    });
...
start = new Date();
console.log(`The greatest product of four adjacent numbers in the same direction in the 20 X 20 grid = ${greatestSum}`);
end = new Date();
